...
namespace Parse
{
    ...
    public class PartInfoClassMap3 : CsvHelper.Configuration.ClassMap<Part4>
    {
        public PartInfoClassMap3(bool requiredFields = true)
        {
            Map(m => m.Name).Name("FLName");
            Map(m => m.Phone).Name("Phone");
        }
    }
